...
namespace UTM.eCommerce.Migrations
{
    ...
    [Migration("20230628181856_ecommerce")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UTM.eCommerce.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("UTM.eCommerce.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("UTM.eCommerce.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.HasOne("UTM.eCommerce.Entities.Order", null)
                        .WithMany()
                        .HasForeignKey("OrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UTM.eCommerce.Entities.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UTM.eCommerce.Entities.Order", b =>
                {
                    b.HasOne("UTM.eCommerce.Entities.Customer", "Customer")
                        .WithMany("Orders")
