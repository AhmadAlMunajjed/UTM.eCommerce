...
public class eCommerceDbMigrationService : ITransientDependency
{
    ...
    private readonly eCommerceEFCoreDbSchemaMigrator _dbSchemaMigrator;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public eCommerceDbMigrationService(
        IDataSeeder dataSeeder,
        eCommerceEFCoreDbSchemaMigrator dbSchemaMigrator,
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "UTM.eCommerce");
    }
