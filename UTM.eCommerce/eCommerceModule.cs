...
using UTM.eCommerce.Data;
using UTM.eCommerce.Localization;
using UTM.eCommerce.Menus;
...
public class eCommerceModule : AbpModule
{
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<eCommerceModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<eCommerceModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    {
        context.Services.AddAutoMapperObjectMapper<eCommerceModule>();
        Configure<AbpAutoMapperOptions>(options =>
        {
             ...
             */
            options.AddMaps<eCommerceModule>(/* validate: true */);
        });
    }
